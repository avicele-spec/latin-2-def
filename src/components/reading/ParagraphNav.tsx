  ...
  return (
    <View style={styles.barra}>
      <Pressable
        ...
        style={({ pressed }) => [styles.pulsante, !puoAndareIndietro && styles.pulsanteDisabilitato, pressed && styles.pulsantePremuto]}
      >
      ...
      <Pressable
        ...
        style={({ pressed }) => [styles.pulsante, !puoAndareAvanti && styles.pulsanteDisabilitato, pressed && styles.pulsantePremuto]}
      >
