      ...
      {inModifica ? (
        <View>
          ...
          <View style={styles.azioniCampo}>
            <Pressable onPress={alSalvare} disabled={salvando || bozza === valore} style={styles.pulsanteSalvaCampo}>
              {salvando ? (
            ...
            {modificato ? (
              <Pressable onPress={alRipristinare} disabled={salvando} style={styles.pulsanteRipristina}>
